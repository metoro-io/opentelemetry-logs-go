...
LoggerProvider from the github.com/metoro-io/opentelemetry-logs-go package can be used as
a default.
...
*/
package logs // import "github.com/metoro-io/opentelemetry-logs-go/logs"
